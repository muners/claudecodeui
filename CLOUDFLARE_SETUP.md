...
ブラウザで `https://claude.your-domain.com` にアクセス。
...
1. ブラウザで `https://claude.your-domain.com` にアクセス
...
# カンマ区切りで複数ドメイン指定可能
VITE_ALLOWED_HOSTS=claude.your-domain.com
...
**複数ドメインを許可する場合:**
```bash
VITE_ALLOWED_HOSTS=claude.your-domain.com,dev.example.com,staging.example.com
```
